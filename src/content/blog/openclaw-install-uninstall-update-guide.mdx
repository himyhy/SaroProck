...
![OpenClaw 连接微信文档提示](photo/openclaw-install-uninstall-update-guide/wechat-step-1-plugin-doc.jpg)
...
![微信插件安装与扫码登录终端输出](photo/openclaw-install-uninstall-update-guide/wechat-step-2-terminal-install.png)

![微信内点击“连接”按钮](photo/openclaw-install-uninstall-update-guide/wechat-step-3-connect-button.jpg)

![微信中测试消息已成功回复](photo/openclaw-install-uninstall-update-guide/wechat-step-4-success-reply.jpg)
